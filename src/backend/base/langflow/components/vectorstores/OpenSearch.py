...
from langflow.io import BoolInput, DataInput, HandleInput, IntInput, StrInput, MultilineInput, DropdownInput, FloatInput
...
class OpenSearchVectorStoreComponent(LCVectorStoreComponent):
    ...
    def get_all_documents(self, vector_store: OpenSearchVectorSearch, **kwargs) -> List[Tuple[Document, float]]:
        ...
        """
        try:
            # Use the OpenSearch client to retrieve all documents
